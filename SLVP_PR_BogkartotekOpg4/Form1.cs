...
namespace SLVP_PR_BogkartotekOpg4
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            bs.DataSource = new { BookID = "", BookTitle = "", Author = "", Publisher = "" };
            ...
            dgvBookList.Columns["Publisher"].DisplayIndex = 3;
        ...
        private void dgvUpdate(Book toBind)
        {
            ...
            else
            {
                ...
                bs.DataSource = new { BookID = toBind.ID, BookTitle = toBind.Title, Author = toBind.Author, Publisher = toBind.Publisher };
            }
            dgvBookList.DataSource = bs;
            // Setting the order of columns shown in the DataGridView.
            dgvBookList.Columns["BookID"].DisplayIndex = 0;
        ...
        private void btnAddBook_Click(object sender, EventArgs e)
        {
            ...
            {
                Book book = new Book(tbAddBookTitle.Text, tbAddBookAuthor.Text, tbAddBookPublisher.Text);
                lib.AddBook(book);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                Book tempBook = new Book(tempID, tbUpdateTitle.Text, tbUpdateAuthor.Text, tbUpdatePublisher.Text);
